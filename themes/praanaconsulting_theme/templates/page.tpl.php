...
<div id="header_wrapper">
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      <?php if (theme_get_setting('social_links', 'praanaconsulting_theme')): ?>
      <div class="social-icons">
       <ul>
        ...
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'praanaconsulting_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'business_responsive_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
        <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'praanaconsulting_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'business_responsive_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
       </ul>
      </div>
    <?php endif; ?>
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'praanaconsulting_theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits">  </p>
    <div class="clear"></div>
    </div>
  </div>
  </div>
